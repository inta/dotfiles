...
dir=$(dirname "$(gsettings get org.gnome.desktop.background picture-uri | sed s/\'file:\\/\\///)")
...
gsettings set org.gnome.desktop.background picture-uri-dark "$new_wallpaper"
